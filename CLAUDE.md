# BWA-MasterWidth — read before doing anything

> ✅ **This is the CANONICAL home for BWA-MasterWidth.** All serious DSP, IP, and
> process for this plugin live **here**, in `~/Developer/BWA-MasterWidth/`. Author here — always.
>
...
> changes. This file deliberately holds only what is specific to BWA-MasterWidth; every
...
4. **`docs/MARKET-PAIN-AND-ATTACKS.md`** — the row for **BWA-MasterWidth**; internalize the pain + attack before any DSP.
...
Then cut a GitHub Release here (`vmcguire/BWA-MasterWidth`) and attach the notarized `BWA-MasterWidth.vst3`.
