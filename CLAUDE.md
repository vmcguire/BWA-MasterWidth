...
> Do all work in the monorepo: **`~/Developer/bwa-fx-ecosystem/BWA-MasterWidth/`**
...
```bash
git subtree push --prefix=BWA-MasterWidth git@github.com:vmcguire/BWA-MasterWidth.git main
```

Then cut a GitHub Release in this mirror and attach the notarized `BWA-MasterWidth.vst3`.
